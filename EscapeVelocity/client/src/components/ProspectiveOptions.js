                ...
                {this.state.OPTIONCHAIN.OptionChain.length > 0 &&
                    <div className='leftmargin'>
                        ...
                        <div>
                            ...
                            <Bubble x={this.state.OPTIONCHAIN.OptionChain.map(leg => leg.StrikePrice)}
                                y={this.state.OPTIONCHAIN.OptionChain.map(leg => leg.CBidPrice)}
                                title='Call Options Bid Price'
                            />
                        </div>
                        ...
                        <div>
                            ...
                            <Bubble x={this.state.OPTIONCHAIN.OptionChain.map(leg => leg.StrikePrice)}
                                y={this.state.OPTIONCHAIN.OptionChain.map(leg => leg.COfferPrice)}
                                title='Call Options Offer Price'
                            />
                        </div>
                        ...
                        <div>
                            ...
                            <Bubble x={this.state.OPTIONCHAIN.OptionChain.map(leg => leg.StrikePrice)}
                                y={this.state.OPTIONCHAIN.OptionChain.map(leg => leg.CNetChange)}
                                title='Call Options Net Change'
                            />
                        </div>
                        ...
                        <div>
                            ...
                            <Bubble x={this.state.OPTIONCHAIN.OptionChain.map(leg => leg.StrikePrice)}
                                y={this.state.OPTIONCHAIN.OptionChain.map(leg => leg.PBidPrice)}
                                title='Put Options Bid Price'
                            />
                        </div>
                        ...
                        <div>
                            ...
                            <Bubble x={this.state.OPTIONCHAIN.OptionChain.map(leg => leg.StrikePrice)}
                                y={this.state.OPTIONCHAIN.OptionChain.map(leg => leg.POfferPrice)}
                                title='Put Options Offer Price'
                            />
                        </div>
                        ...
                        <div>
                            ...
                            <Bubble x={this.state.OPTIONCHAIN.OptionChain.map(leg => leg.StrikePrice)}
                                y={this.state.OPTIONCHAIN.OptionChain.map(leg => leg.PNetChange)}
                                title='Put Options Net Change'
                            />
                        </div>

                        <div>

                            <HorizontalBar y={this.state.OPTIONCHAIN.OptionChain.map(leg => leg.StrikePrice)}
                                x1={this.state.OPTIONCHAIN.OptionChain.map(leg => leg.COpenInterest)}
                                x2={this.state.OPTIONCHAIN.OptionChain.map(leg => (leg.POpenInterest))}
                                title='Open Interest'
                            />
                        </div>
                        ...
                        <div>
                            ...
                            <HorizontalBar y={this.state.OPTIONCHAIN.OptionChain.map(leg => leg.StrikePrice)}
                                x1={this.state.OPTIONCHAIN.OptionChain.map(leg => leg.CChangeInOI)}
                                x2={this.state.OPTIONCHAIN.OptionChain.map(leg => (leg.PChangeInOI))}
